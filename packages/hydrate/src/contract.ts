/**
 * @ggpwnkthx/dom-hydrate - Hydration contract documentation.
 * @module
 */
 ...
 * =========================
 *
 * SSR output from `@ggpwnkthx/ssr` uses `data-hk` attributes with dot-separated
 * path notation to mark element nodes. Hydration uses these markers to align
 * vnode trees with existing DOM.
 *
 * Path Format
 * -----------
 ...
 * Fragment Handling
 * -----------------
 * Fragments are flattened during SSR emission. Fragment children continue
 * the parent's sibling counter. No markers are emitted for fragment wrappers.
 *
 * Example
 * -------
 * Fragment: `[child1, child2]` inside `<div>`
